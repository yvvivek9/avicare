...
class Protocol {
  ...
  static Future<void> addProtocol(Protocol data) async {
    final response = await httpPostRequest(route: "/admin/protocol/add", body: data.toJSON());
  }

  static Future<void> updateProtocol(Protocol data) async {
    final response = await httpPostRequest(route: "/admin/protocol/update", body: data.toJSON());
  }

  static Future<void> deleteProtocol(Protocol data) async {
    final response = await httpPostRequest(route: "/admin/protocol/delete", body: {"protocol_id": data.id});
  }
