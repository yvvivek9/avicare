...
class UpdateProtocolController extends GetxController {
...
class UpdateProtocolDialog extends StatelessWidget {
  UpdateProtocolDialog({super.key, required this.protocol}) {
    controller.nameController.text = protocol.name;
  ...
  final controller = Get.put(UpdateProtocolController());
