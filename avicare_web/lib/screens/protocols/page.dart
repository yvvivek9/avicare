...
class ProtocolsPage extends StatelessWidget {
  ProtocolsPage({super.key});

  final controller = Get.put(ProtocolsPageController());
        ...
        children: [
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  SizedBox(width: 30.w),
                  InkWell(
                    onTap: controller.handleAddProtocol,
                    child: Container(
                      width: 54.h,
                      height: 54.h,
                      decoration: BoxDecoration(
          ...
          Obx(
              ...
              child: GridView.builder(
                ...
                itemCount: controller.protocols.value.length,
                itemBuilder: (context, index) {
                  return GridTileWidget(
                    protocol: controller.protocols.value[index],
                    handleDelete: (protocol) => controller.handleDeleteProtocol(protocol),
                    handleUpdate: (protocol) => controller.handleUpdateProtocol(protocol),
                  );
                },
              ),
            ),
