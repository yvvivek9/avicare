...
class NewExerciseController extends GetxController {
  ...
  Future<void> handleSubmit() async {
    if (nameController.text == "" || descriptionController.text == "" || youtubeController.text == "" || stepsController.text == "" || imageData.value == null) {
      ...
      try {
        await Exercise.addExercise(Exercise(
          id: "",
...
class NewExerciseDialog extends StatelessWidget {
  const NewExerciseDialog({super.key});
  
  // final controller = Get.put(NewExerciseController());
  // final controller = Get.create(() => NewExerciseController());

  @override
  Widget build(BuildContext context) {
    return Dialog(
      child: GetBuilder<NewExerciseController>(
        init: NewExerciseController(),
